...
void ReferenceGRF::SetContactData(double* contact_state_in, double* min_forces_in, double* max_forces_in, double threshold, int stance_legs_in)
{
...
void ReferenceGRF::calc_H_qpOASES()
{
  ...
  Eigen::MatrixXd IDNTY;
  IDNTY.setIdentity(NUM_VARIABLES_QP_DES, NUM_VARIABLES_QP_DES);
