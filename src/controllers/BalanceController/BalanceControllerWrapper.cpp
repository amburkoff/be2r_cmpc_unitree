...
extern "C"
{
  ...
  void balanceControl_set_desiredTrajectoryData(double* rpy_des_in, double* p_des_in,
                                                double* omegab_des_in,
                                                double* v_des_in) //, double* vdot_des_in)
  {
    BalanceControllerObj->set_desiredTrajectoryData(rpy_des_in, p_des_in, omegab_des_in,
                                                    v_des_in); //, vdot_des_in );
  }
  ...
  void balanceControl_set_PDgains(double* Kp_COM_in, double* Kd_COM_in, double* Kp_Base_in,
                                  double* Kd_Base_in)
  {
  ...
  void balanceControl_set_friction(double mu_in) { BalanceControllerObj->set_friction(mu_in); }
  ...
  void balanceControl_set_mass(double mass_in) { BalanceControllerObj->set_mass(mass_in); }
  ...
  void balanceControl_updateProblemData(double* xfb_in, double* pFeet_in, double yaw_in)
  {
    ...
    BalanceControllerObj->updateProblemData(xfb_in, pFeet_in, p_des, p_act, v_des, v_act, O_err,
                                            yaw_in);
  }

  void balanceControl_SetContactData(double* contact_state_in, double* min_forces_in,
                                     double* max_forces_in)
  {
    BalanceControllerObj->SetContactData(contact_state_in, min_forces_in, max_forces_in);
  }
  ...
  double balanceControl_get_fOpt_matlab(int index) { return xOpt_force[index - 1]; }
